...
const jaedanPartforminsertData = async () => {
 ...
 console.log("jaedanPartform.JAEDAN_PRODUCT_PART");
 //
 // WORKING_PART 검증
 // 
 // WORKING_PART 검증
 ...
 const countNumber = Number(jaedanPartform.COUNT);
 ...
 try {
   ...
   console.log("jaedanPartform",jaedanPartform)
   alert("등록되었습니다.");
   // form 값 초기화
...
// excel 데이터 받기
const exportToExcel = () => {
  const data = jaedanPartOrderList.value; // Assuming getInsertData contains the table data
