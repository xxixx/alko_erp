<template>
  <div class="w-full max-w-3xl mx-auto py-2">
    <h6 class="text-center mt-2">생산 현황 / 재단물을 생산에 투입하면 공정진행표 발행으로 변경됨</h6>
    <h6 class="text-center mt-2">생산투입 =  재단에서 재단완성 후 재단물이 넘어오게 되면 생산투입으로 보이게 됨</h6>
       <div v-if="isLoading">
  ...
  <td class="d-none d-md-table-cell">{{ formatDate(item.Y_COUNT) }}</td> -->
              ...
              <td>
                ...
                <div v-if="item.PROCESS_STATE === 1" class="d-grid gap-2">
                  <button
