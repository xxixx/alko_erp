    ...
    <div class="d-flex flex-wrap flex-column">
      <div>
        ...
        <div class="">
         ...
         <!-- <p>품명을 선택하세요</p> -->
              <select class="selectpicker form-control-sm" data-style="btn-info" style="width: 40%;"   id="selectedProduct" v-model="selectedProduct">
                    <!-- <option  selected>품명을 선택하세요</option> -->
               ...
               <input  class="form-control me-2" style="width: 20%;" type="text" v-model="barcodeDate">
               <button class="btn btn-sm btn-warning" style="width: 30%;" @click="makeBarcodeData"> 바코드 조회 등록</button>
        </div>
        ...
        <table class="table table-striped table-bordered text-center">
          <thead>
           ...
           <tbody>
             <tr class="">
               <td class="">{{selectedProduct?.NO}}</td>
              ...
              <tr>
                ...
                <td colspan="4" class="">
                  <div class="d-flex justify-content-around align-items-center">
                    ...
                    <button class="btn btn-sm btn-warning" style="width: 50%;" @click="generateBarcodes" :disabled="!productsCode.PRODUCT_CODE || quantity <= 0" > 바코드 생성 </button>
                  </div>
...
const makeBarcodeData = async () => {
  ...
  const PRODUCT_CODE = selectedProduct.value.PRODUCT_BARCODE + barcodeDate.value;
  ...
  try {
    ...
    if (makeBarcodeData) {
      ...
      for (let i = startNumber; i <= endNumber; i++) {
        const barcode = `${productsCode.value.PRODUCT_BARCODE}${barcodeDate.value}${i.toString().padStart(5, "0")}`;
      ...
      router.push({
        ...
        query: {
          ...
          productBarcode: productsCode.value.PRODUCT_BARCODE, // 추가된 barcodeData 데이터
